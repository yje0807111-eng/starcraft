...
> | | 2026-09-11 현재 |
> |---|---|
> | ✅ 끝남 | **레벨 축**(`C.lv`·`C.xp`·`C.lvPts` · `campAddXp`) · 지급은 캠프 전투의 죽은 유닛 정리 한 곳 · 회차 되감기에 레벨·포인트·트리 포함 · **성장 트리를 회차 크기로**(차수 1 · 43노드 · 83점 · BALANCE §5-11) · **환생의 자를 「도달 깊이」로**(관문 = 마지막 던전 클리어 · 포인트 = 통산 관문 수 · 배수 = 1 + 횟수) |
> | ⏳ 남음 | **환생 포인트 소비처 넷**(스킵 · 자동화 · 기본 배수 · 상한 해제) · 룬 칸 해금을 레벨로 · `CAMP_RT_PTS_FREE` 끄기 · 무한층(단계 3) |
> | ⚠ 안 쟀다 | `CAMP_XP_KILL`·`CAMP_XP_A`·`CAMP_XP_R` · 트리 사다리 넷 — 근거는 「요구량 배수 > 관문 평균」 하나뿐(BALANCE §0) |
>
