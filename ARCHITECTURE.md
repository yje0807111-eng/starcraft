...
- 🚧 **고칠지는 아직 안 정했다.** 막으려면 밀어내기가 필요한데 ⛔ 그건 2026-09-05 갇힘의 원인이라
  금지돼 있다. 후보 둘: ① **선 검사를 촘촘히**(36.6% 몫 · 값싸고 가두지도 않는다 — ⚠ 안 해 봤다)
  ② 「절벽을 넘을 때만 속도를 크게 깎는다」처럼 **가두지 않는 벌칙**(54% 몫). 정하기 전에는 건드리지 말 것.
