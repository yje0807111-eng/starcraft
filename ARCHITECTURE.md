...
- 🚧 **남은 절반(59%)은 여전히 미해결이다.** 우회점을 제대로 줬는데도 몸이 절벽을 통과한다.
  ⛔ 밀어내기는 금지(2026-09-05 갇힘). ⭐ 다음에 볼 곳은 **속도가 아니라 방향**이다 —
  그 59% 에서 유닛을 실제로 움직인 것이 무엇인지(웨이포인트인지 · 유닛끼리 밀어내는 힘인지)를
  **먼저 갈라 재고** 손댈 것. 안 재고 또 벌칙을 붙이면 이번처럼 헛돈다.
