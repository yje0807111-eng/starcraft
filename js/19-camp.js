...
//     ⭐ 그래서 느린 유닛만 바닥을 올린다 — 공성전차·기갑병 5.0 → **6.5칸/초**, 전함 → 6.0.
//       원작 감각(전차가 레인저보다 느리다)은 유지하되 「못 쓸 만큼」은 아니게 둔다.
//     ⛔ 빠른 유닛에는 s 를 주지 않는다 — 건드릴 이유가 없고, 값이 늘면 관리가 어려워진다.
//
...
const CAMP_UNIT_STAT = {
  ...
  goliath:{a:3,h:14,r:6.0,c:1.0,s:6.5}, ghost:{a:4,h:9,r:8.0,c:1.6}, medic:{h:23,r:2.0},
  pelican:{h:27}, aegis:{h:23}, tank:{a:12,h:22,r:9.0,c:2.2,s:6.5}, skyguard:{a:4.5,h:22,r:5.0,c:1.0},
  hellfire:{a:10,h:28,r:6.5,c:1.6}, dreadnought:{a:31,h:47,r:7.0,c:2.0,s:6.0},
  // 스웜 §3-A
