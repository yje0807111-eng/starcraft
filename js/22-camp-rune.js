...
//
// ⚠ **문턱 값은 아직 안 쟀다**(2026-09-11 출발점). 손에 있는 실측은 하나뿐이다 —
//   `node scripts/camp-clear.mjs` 기준 **환생 없이 던전 3 까지 완주하면 Lv.18**(BALANCE §5-11).
//   그 하나에 기대어 「첫 완주 = 27칸 중 18칸」이 되게 놓았고, 나머지 9칸은 환생 몇 번의 몫이다.
//   ⛔ 확정치로 읽지 말 것 — 레벨 곡선 셋(CAMP_XP_KILL·_A·_R)도 아직 안 쟀으므로 같이 움직인다.
const RUNE_SLOT_LV = {
