...
const RUNE_LIST = [
  // ── 일반 14종 ── 값은 RUNE_VAL 이 정한다(하급 1% · 중급 2.5% · 상급 5%)
  //   ⚠ 갈래마다 **7종**이 목표다(칸이 8이라 하나는 두 번 끼우게 된다 — 그게 마지막 선택이다).
  //     지금 경제 6 · 전투 4 · 성장 4. 나머지는 채우는 중이다(2026-09-05).
  ...
  { id:'reb',   nm:'윤회의 룬',   kind:'norm', grp:'eco',  eff:'rebPts',  ico:'new',
    de:'환생 포인트 획득' },
  // ✨ 치명 터치 둘 — 확률과 배수를 **따로** 판다(2026-09-05 사용자 확정).
  //   ⭐ 피버(열기·열정)와 같은 짜임이다: 얼마나 자주 오나 ↔ 왔을 때 얼마나 큰가.
  //   ⚠ 확률 룬은 **비율 곱**이라 기본 확률이 작으면 체감이 없다 — 기본을 10% 로 잡은 이유다
